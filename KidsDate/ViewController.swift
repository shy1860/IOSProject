    ...
    @IBAction func btnLogin(_ sender: Any) {
        ...
        if currentUser.userName.isEqual(""){
            ...
            if currentUser.password != User.userLogin.password{
                ...
                db.createEvent(event: Event(title: "Baseball Kids 5-6", detail: "Would like a kids between 5-6 sharing equipment and experience",
                                            date: "202004021000", location: "Casa Loma Castle Room 101",
                                            category: "Outdoor", ownerID: "2"),user: currentUser)
                db.createEvent(event: Event(title: "Basketball  Teen 13-16", detail: "Need 5 members as routine team for competition", date: "202004031130", location: "TBA", category: "Indoor", ownerID: "1"),user: currentUser)
